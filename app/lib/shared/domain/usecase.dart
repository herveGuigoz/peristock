...
import 'package:peristock/shared/domain/result.dart';
...
class UsecaseProvider<Command, State>
    extends FutureProviderFamily<Result<State>, Command> {
  UsecaseProvider(
...
// ignore: subtype_of_sealed_class
class AutoDisposeUsecaseProvider<Command, State>
    extends AutoDisposeFutureProviderFamily<Result<State>, Command> {
